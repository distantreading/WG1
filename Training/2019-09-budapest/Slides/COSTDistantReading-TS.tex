...
\begin{itemize}
	\item Schedule on \url{https://github.com/distantreading/WG1/wiki/TS-Budapest}
	\item Slides on \url{https://github.com/distantreading/WG1/tree/master/Training/2019-09-budapest}
	\item Data on \url{https://github.com/COST-ELTeC}
\end{itemize}
...
\begin{itemize}
\item Introduction to ELTeC
\item Metadata in the teiHeader
\item Optical character recognition
	\item Hands-on experience in creating ELTeC TEI-XML versions of source texts 
	\item Start from scanned page images or from a pre-existing HTML version
	\item Our goal: contribute new TEI encoded texts to the ELTeC GitHub repository
\end{itemize} 
}
...
100 texts per language (language collection)
	\begin{itemize}
		...
		\item \textbf{reprint}: min. 30\% are highly canonized novels, min. 30\% should be non-canonized novels (rarely or never reprinted), based reprint counts within the period 1970-2009 ("unmarked", information not yet available, "unspecified" information about the number of reprints not yet determined)
	\end{itemize}
}
...
\begin{itemize}
	...
	\end{itemize}
	\item ELTeC on GitHub\footnote{\url{https://github.com/COST-ELTeC}}
	\begin{itemize}
